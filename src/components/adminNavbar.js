...
// Function to handle CSS classes
...
const AdminNavbar = (props) => {
  const navigate = useNavigate(); // Navigational hook
  console.log("props", props);
  const user = props.admin ? props.admin : null; // Assigning user based on props.admin
  ...
  // Array containing user navigation links
...
const mapStateToProps = (storeState) => {
  return {
    admin: storeState.adminState.admin,
  };
};
export default connect(mapStateToProps, { adminSignOut })(AdminNavbar);
